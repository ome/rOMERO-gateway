...
RUN apt-get -y install libssl-dev libxml2-dev libcurl4-gnutls-dev libfontconfig1-dev libharfbuzz-dev libfribidi-dev libfreetype6-dev libpng-dev libtiff5-dev libjpeg-dev
